...
CREATE TABLE `itemcompras` (
  ...
  PRIMARY KEY (`idProduto`,`idFornecedor`,`idCompra`),
  KEY `fk_ItemCompras_Compras1` (`idCompra`),
  CONSTRAINT `fk_ItemCompras_Compras1` FOREIGN KEY (`idCompra`) REFERENCES `compras` (`idCompra`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_ItemCompras_Prod_For1` FOREIGN KEY (`idProduto`, `idFornecedor`) REFERENCES `prod_for` (`idProduto`, `idFornecedor`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2020-02-06 23:20:07
